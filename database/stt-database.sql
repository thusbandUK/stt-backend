...
CREATE TABLE verification (id SERIAL,hashed_string bytea NOT NULL,date_stored DATE NOT NULL,user_id INTEGER REFERENCES users(id) NOT NULL,PRIMARY KEY (id));
